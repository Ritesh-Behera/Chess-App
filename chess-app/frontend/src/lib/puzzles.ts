...
export const PUZZLES: ChessPuzzle[] = [
  {
    ...
    rating: 800,
    theme: "Mate in 1",
    description: "White to move. Exploit Black's vulnerable back rank to deliver checkmate.",
    playerColor: "w",
  ...
  },
  {
    ...
    rating: 850,
    theme: "Mate in 1",
    description: "White to move. Find the single decisive move to end the game immediately.",
    playerColor: "w",
  ...
  },
  {
    ...
    rating: 1100,
    theme: "Tactics",
    description: "White to move. Win material and capitalize on the uncastled black king.",
    playerColor: "w",
    solution: [
      { from: "d1", to: "e2" },
      { from: "d7", to: "d5" },
  ...
  },
  {
    ...
    rating: 1050,
    theme: "Fork",
    description: "White to move. Find the best tactical sequence to win material.",
    playerColor: "w",
  ...
  },
  {
    ...
    rating: 950,
    theme: "Tactics",
    description: "White to move. Defend against the enemy Queen infiltration efficiently.",
    playerColor: "w",
  ...
  },
  {
    ...
    rating: 900,
    theme: "Mate in 1",
    description: "White to move. Find the fastest route to checkmate.",
    playerColor: "w",
  ...
  },
  {
    ...
    rating: 1150,
    theme: "Fork",
    description: "White to move. Get out of check and simultaneously create counter-threats.",
    playerColor: "w",
  ...
  },
  {
    ...
    rating: 800,
    theme: "Mate in 1",
    description: "White to move. Punish Black's lack of king escape squares.",
    playerColor: "w",
  ...
  },
  {
    ...
    rating: 850,
    theme: "Mate in 1",
    description: "White to move. Deliver checkmate in 1 move.",
    playerColor: "w",
  ...
  },
  {
    ...
    rating: 950,
    theme: "Tactics",
    description: "Black to move. Activate your back-rank rook and dominate the open file.",
    playerColor: "b",
  ...
  },
  {
    ...
    rating: 1200,
    theme: "Endgame",
    description: "White to move. Find the most active square for your king in this king-and-pawn endgame.",
    playerColor: "w",
  ...
  },
  {
    ...
    rating: 1050,
    theme: "Discovery",
    description: "White to move. Develop with tempo and challenge Black's centralized knight.",
    playerColor: "w",
  ...
  },
  {
    ...
    rating: 700,
    theme: "Mate in 1",
    description: "White to move. Attack the weakest square in Black's camp to win the game instantly.",
    playerColor: "w",
  ...
  },
  {
    ...
    rating: 850,
    theme: "Mate in 1",
    description: "White to move. Find the winning tactic to checkmate.",
    playerColor: "w",
    solution: [{ from: "d4", to: "d8" }],
  },
];
